...
;
const metadata = {
    title: "Amanda Gérard | Chef de projet e-commerce",
    description: "Portfolio d'Amanda Gérard, cheffe de projet digital senior spécialisée Shopify, logistique e-commerce et process opérationnels.",
    generator: "v0.app",
    icons: {
        icon: [
            {
